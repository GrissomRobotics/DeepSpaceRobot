...
import org.usfirst.frc.team3319.swerve.math.SwerveDirective;
import org.usfirst.frc.team3319.swerve.math.SwerveMath;
...
public class SwerveDrive {
    ...
    public void disablePID() {
    	((DriveEnclosure) swerveEnclosure1).disable();
    	((DriveEnclosure) swerveEnclosure2).disable();
    	((DriveEnclosure) swerveEnclosure3).disable();
    	((DriveEnclosure) swerveEnclosure4).disable();
    	
    	
    }

	public void setPIDValuesFromDashboard() {
		((DriveEnclosure) swerveEnclosure1).setPIDValuesFromDashboard();
    	((DriveEnclosure) swerveEnclosure2).setPIDValuesFromDashboard();
    	((DriveEnclosure) swerveEnclosure3).setPIDValuesFromDashboard();
    	((DriveEnclosure) swerveEnclosure4).setPIDValuesFromDashboard();
    }
    
    public void setSteerPosition(double angle) {
        swerveEnclosure1.move(0,angle);
        swerveEnclosure2.move(0,angle);
        swerveEnclosure3.move(0,angle);
